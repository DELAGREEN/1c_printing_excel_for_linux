...
def writer_for_excel(_strings, path_to_excel:str, separator_first:str, separator_end:str):
    ...
    for i in list_strings:
        ...
        len_arr_cell = len(cell_data_set)
        if len_arr_cell == 3:
            _row, _column, _value = cell_data_set                           #дробим строку на [номер строки][номер столбца][значение ячейки] 
            ...
            _row, _column, _value, _sheet_num = cell_data_set               #дробим строку на [номер строки][номер столбца][значение ячейки][номер страницы]
